...
Item {
    ...
    property bool _flying: QGroundControl.multiVehicleManager.activeVehicleAvailable? QGroundControl.multiVehicleManager.activeVehicle.flying : false;
    property bool _armed: QGroundControl.multiVehicleManager.activeVehicleAvailable? QGroundControl.multiVehicleManager.activeVehicle.armed : false;
